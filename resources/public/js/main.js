...
document.write('<script>if (typeof goog != "undefined") { goog.require("sms_application.web_view"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');